...
return view.extend({
  ...
  render: function (data) {
    ...
    o = s.option(
      ...
      "site_url",
      _("Site URL"),
      _("This option is intended for deployments using a CDN and updates the `site_url` field in the configuration file. Leave it empty if you are unsure what it does."),
    );
    ...
    o = s.option(
      ...
      "log_filter_enable",
      _("Enable Log Filter"),
      _("Filters access logs generated by health checks, HEAD requests, and common WebDAV requests. It does not block these requests."),
    );
    o.depends("log_enable", "1");
    o.default = "0";
